...
main.snd: main.bbl
	...
	sed -i 's/.*Institut*//' main.adx
	sed -i 's/.*Research.*//' main.adx
	sed -i 's/.*ASALE.*//' main.adx
	sed -i 's/.*Estudis.*//' main.adx
	sed -i 's/.*RAE.*//' main.adx
	sed -i 's/.*País.*//' main.adx
	sed -i 's/.*Directorate.*//' main.adx
	sed -i 's/.*Board.*//' main.adx
	sed -i 's/.*DWDS.*//' main.adx
	sed -i 's/.*ELIA.*//' main.adx
	sed -i 's/.*GALA.*//' main.adx
	sed -i 's/.*KantanMT.*//' main.adx
	sed -i 's/.*me too.*//' main.adx
	sed -i 's/.*SDL.*//' main.adx
	sed -i 's/.*Slator.*//' main.adx
	sed -i 's/.*TAUS.*//' main.adx
	sed -i 's/.*Twitter.*//' main.adx
